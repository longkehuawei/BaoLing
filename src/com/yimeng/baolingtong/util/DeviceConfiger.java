package com.yimeng.baolingtong.util;


import com.yimeng.baolingtong.MyApp;
...
public class DeviceConfiger {
    ...
    /**
     * 获取屏幕方向�? 1 、横�? ORIENTATION_LANDSCAPE 2 、竖�? ORIENTATION_PORTRAIT
     * 
     * @return
     */
