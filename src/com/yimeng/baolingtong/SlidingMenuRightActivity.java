...
public class SlidingMenuRightActivity extends AbActivity  implements OnMenuItemClickListener,OnMenuItemLongClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout titleLayout=(RelativeLayout) LayoutInflater.from(SlidingMenuRightActivity.this).inflate(R.layout.main_title_bar,null);
		...
		progressBar=(AbHorizontalProgressBar) titleLayout.findViewById(R.id.horizontalProgressBar);
	...
	@Override
	public void onMenuItemLongClick(View clickedView, int position, boolean selected) {
//		Toast.makeText(this, "menu position="+position, Toast.LENGTH_SHORT).show();
	}
